                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text:
                                        'By opting into test messages, you agree to receive automated marketing messages from Ecobin at\n',
                                  ),
                                  TextSpan(
                                    text: '+91 9000331528',
                                    style: fontStyle.body.copyWith(
                                  ...
                                  TextSpan(
                                    text:
                                        '. To receive messages to a different number, ',
                                  ),
                                  TextSpan(
                                  ...
                                  const TextSpan(
                                    text: 'on your persona info page.',
                                  ),
                                ],
                              ),
                            ),
